...
PRETTIFY_SYSTEM_PROMPT = (
    ...
    "3. PRESERVE LINE BREAKS EXACTLY, including blank lines. A blank line in "
    "the input marks a pause where the speaker started a new thought. Keep each "
    "blank line as a blank line in the output — never merge separate paragraphs "
    "into one, never collapse a blank line into a single newline or a space, "
    "and never add breaks that weren't there.\n\n"
    "Examples:\n\n"
    "Input: <transcript>Давай попробуем.\n\nЯ сделал паузу, интересно.</transcript>\n"
    "Output: Let's try.\n\nI made a pause, interesting.\n\n"
