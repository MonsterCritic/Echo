...
PRETTIFY_SYSTEM_PROMPT = (
    ...
    "3. PRESERVE LINE BREAKS EXACTLY. Each newline in the input marks a pause "
    "where the speaker started a new thought. Keep every line break as a line "
    "break in the output — never merge separate lines into one paragraph, and "
    "never add line breaks that weren't there.\n\n"
    "Examples:\n\n"
